...
class Constructor:
    ...
    def __init__(self, master, width, height):
        ...
        # Frame instantiation
        self.homepanel = tk.Frame(self.master, width=self.width, height=self.height, bd=0, bg=colors.BG_COLOR)
        self.autopanel = tk.Frame(self.master, width=self.width, height=self.height, bd=0, bg=colors.BG_COLOR)
        self.manpanel = tk.Frame(self.master, width=self.width, height=self.height, bd=0, bg=colors.BG_COLOR)
        self.settingspanel = tk.Frame(self.master, width=self.width, height=self.height, bd=0, bg=colors.BG_COLOR)
        self.changepasspanel = tk.Frame(self.master, width=self.width, height=self.height, bd=0, bg=colors.BG_COLOR)
        self.vkeyboardpanel = tk.Frame(self.master, width=self.width, height=self.height, bd=0, bg=colors.BG_COLOR)
        self.paramspanel = tk.Frame(self.master, width=self.width, height=self.height, bd=0, bg=colors.BG_COLOR)
        self.resettubepanel = tk.Frame(self.master, width=self.width, height=self.height, bd=0, bg=colors.BG_COLOR)
        self.resetconsumpanel = tk.Frame(self.master, width=self.width, height=self.height, bd=0, bg=colors.BG_COLOR)
        self.statisticspanel = tk.Frame(self.master, width=self.width, height=self.height, bd=0, bg=colors.BG_COLOR)
        self.pubpanel = tk.Frame(self.master, width=self.width, height=self.height, bd=0, bg=colors.BG_COLOR)

        # Pop-ups
        self.pop_resettubepanel = tk.Frame(self.master, width=300, height=200, bd=0, bg=colors.BG_COLOR)
        self.pop_resettubepanelout = tk.Frame(self.master, width=300, height=200, bd=0, bg=colors.BG_COLOR)
        self.pop_resetconsumpaneluv = tk.Frame(self.master, width=300, height=200, bd=0, bg=colors.BG_COLOR)
        self.pop_resetconsumpanelo3 = tk.Frame(self.master, width=300, height=200, bd=0, bg=colors.BG_COLOR)
        self.pop_feedtkpanel = tk.Frame(self.master, width=300, height=200, bd=0, bg=colors.BG_COLOR)
        self.pop_reactorpanel = tk.Frame(self.master, width=300, height=200, bd=0, bg=colors.BG_COLOR)
        self.pop_feedpmppanel = tk.Frame(self.master, width=300, height=200, bd=0, bg=colors.BG_COLOR)
        self.pop_outpmppanel = tk.Frame(self.master, width=300, height=200, bd=0, bg=colors.BG_COLOR)
        self.pop_recirpmppanel = tk.Frame(self.master, width=300, height=200, bd=0, bg=colors.BG_COLOR)
        self.pop_uvpanel = tk.Frame(self.master, width=300, height=200, bd=0, bg=colors.BG_COLOR)
        self.pop_o3panel = tk.Frame(self.master, width=300, height=200, bd=0, bg=colors.BG_COLOR)
        self.pop_o2panel = tk.Frame(self.master, width=300, height=200, bd=0, bg=colors.BG_COLOR)
        self.pop_shutdown = tk.Frame(self.master, width=300, height=200, bd=0, bg=colors.BG_COLOR)
        self.pop_resetstatspanel = tk.Frame(self.master, width=300, height=200, bd=0, bg=colors.BG_COLOR)
        self.pop_gemapanel = tk.Frame(self.master, width=300, height=200, bd=0, bg=colors.BG_COLOR)
        self.pop_vapanel = tk.Frame(self.master, width=300, height=200, bd=0, bg=colors.BG_COLOR)
        self.pop_steripanel = tk.Frame(self.master, width=300, height=200, bd=0, bg=colors.BG_COLOR)
        ...
        self.resetconsumapp = resetconsum.Winresetconsum(self, self.resetconsumpanel)
        self.statisticsapp = statistics.Winstatistics(self, self.statisticspanel)
